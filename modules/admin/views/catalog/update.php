...
$this->registerJsFile('/js/product.js', ['depends' => \app\assets\AdminAsset::class]);
...
<div class="row">
    ...
    <div class="col-md-9">
        ...
        <div class="form-group">
            <div class="row">
                <div class="col-md-3"><?php echo $form->field($model, 'article')->textInput(['readonly' => true]); ?></div>
                <div class="col-md-9">
                    <div class="form-group field-products-color">
                        <label class="control-label" for="products-color">Цвета</label>
                        <div class="form-control" disabled="true" style="min-height:34px;height:auto !important"><?php echo $model->color;?></div>
        ...
        <?php echo $form->field($model, 'description')->widget(TinyMce::class, [
            'options' => [],
            'language' => 'ru',
            'clientOptions' => [
                ...
                'images_upload_url' => Url::toRoute(['/'.MODULE_ID.'/default/upload']),
