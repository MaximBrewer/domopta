...
$this->registerJsFile('/js/catalog.js', ['depends' => \app\assets\AdminAsset::class]);
?>
<div class="row">
    <div class="col-md-3">
    ...
    <div class="col-md-9">
        <?= Html::beginForm(['/'.MODULE_ID.'/catalog/deletemultiply', 'id' => $category->id], 'post', ['id' => 'deletemultiply-form']) ?>
        <?php if($category->id): ?>
