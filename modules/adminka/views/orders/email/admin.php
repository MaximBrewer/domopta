...
<div style="margin:0 auto;max-width:992px;">
            ...
            <td style="padding-right:20px;width:40%;">
                <table style="vertical-align: top;" width="100%">
                    ...
                    <?php if ($profile->order_comment) : ?>
                        ...
                        <tr>
                            <td style="font-size: 16px; font-weight: bold;text-transform:uppercase;">
                                <?php echo $profile->order_comment; ?>
                            </td>
                        </tr>
                    <?php endif; ?>
                </table>
    ...
    <table style="font-size: 12px; border: 1px solid #333; border-collapse:collapse; margin-top: 20px ;" border="1" cellpadding="4" cellspacing="0" width="100%">
        ...
        foreach ($details as $i => $detail) :
            ...
            <tr <?php if (!$detail->flag || !$dproduct->flag) { ?>class="strikeout" <?php } ?>>
            <?php endif; ?>
    ...
    <table style="width:100%;border-collapse:collapse;">
        <tr style="vertical-align: top;">
            <td>
                Итого, О:&nbsp;&nbsp;&nbsp;<?php echo Products::formatEmailItog($total_o, true); ?><br />
                Итого, Р:&nbsp;&nbsp;&nbsp;<?php echo Products::formatEmailItog($total_t, true); ?>
            </td>
