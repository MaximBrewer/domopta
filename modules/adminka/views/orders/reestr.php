...
<table cellpadding="10" border="1" width="100%" style="font-size:11pt;word-wrap:break-word;">
	<thead>
		<tr style="vertical-align:center;">
			...
			<th width="12" style="border: 1px solid black;font-size:12pt;font-weight:bold"></th>
	...
	<tbody>
		...
		foreach ($orders as $k => $model) : ?>
			<tr style="vertical-align:center;">
				...
				<td style="border: 1px solid black;font-size:12pt;font-weight:bold"></td>
				...
				<td valign="center" align="center" style="border: 1px solid black;"><?php echo $model->city; ?></td>
