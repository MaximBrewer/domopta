        ...
        $("#suggest").suggestions({
            ...
            onSelect: function(suggestion) {
                ...
                if (suggestion.data.type == "INDIVIDUAL") {
                    ...
                    $("#reg_city").show();
                    $("#profile-city").val(suggestion.data.address.data.settlement ? suggestion.data.address.data.settlement : suggestion.data.address.data.city);
                    $("#reg_inn").show();
                    ...
                    $("#reg_name").show();
                    $("#profile-name").val("").attr("readonly", false);
                    $("#reg_secondname").show();
                    $("#profile-lastname").val("").attr("readonly", false);;
                    $("#reg_surname").show();
                    $("#profile-surname").val("").attr("readonly", false);
                    $("#reg_region").show();
                    $("#profile-region").val(suggestion.data.address.data.region);
                    $("#reg_manager").show();
                    $("#profile-manager").val(suggestion.data.management.name);
                    $("#reg_city").show();
                    $("#profile-city").val(suggestion.data.address.data.settlement ? suggestion.data.address.data.settlement : suggestion.data.address.data.city);
                    $("#reg_inn").show();
                    $("#profile-inn").val(suggestion.data.inn);
