                ...
                <div class="reg-step2-wrap">
                    ...
                    <div class="reg-step2-item">
                        ...
                        <ul class="reg-step2-item-info">
                            ...
                            <li>Для Предпринимателей (ИП)<br/>
                                от <?=number_format(\Yii::$app->settings->get('Settings.min1'), 0, '.', '.');?> рублей.<br/>
                                Форма оплаты наличный и безналичный расчет. </li>
                            <li>
                                Для Юридических лиц (ООО)<br/>
                                от <?=number_format(\Yii::$app->settings->get('Settings.min3'), 0, '.', '.');?> рублей.<br/>
                    ...
                    <div class="reg-step2-item">
                        ...
                        <ul class="reg-step2-item-info">
                            ...
                            <li>Заказы формируются<br />от <?=number_format(\Yii::$app->settings->get('Settings.min2'), 0, '.', '.');?> рублей.</li>
