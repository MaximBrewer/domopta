            ...
            <div class="register-bottom">
                <div class="reg-step2-wrap">
                    <div class="reg-step2-item">
                        <img src="/img/reg-step2-item-img1.png" alt="" class="reg-step2-item-img">
                        <!-- /.reg-step2-item-img -->
                        ...
                        <ul class="reg-step2-item-info">
                            ...
                            <li>При регистрации необходимо будет заполнить регистрационные данные Предпринимателя (ИП);</li>
                            <li>Заказы формируются<br>от 7.000 рублей;</li>
                        ...
                        <!-- /.reg-step2-item-info -->
                        <div class="reg-step2-item-button register__btn"><a href="/reg/full?step=1&type=1">продолжить регистрацию</a></div>
                    ...
                    <div class="reg-step2-item">
                        ...
                        <ul class="reg-step2-item-info">
                            <li>Тип цен: Опт</li>
                            <li>По завершении регистрации видны только оптовые цены;</li>
                            <li>При регистрации необходимо будет заполнить регистрационные данные Юридического лица (ООО);</li>
                            <li>Заказы формируются<br>от 10.000 рублей;</li>
                            <li>Форма оплаты:<br>безналичный расчет;</li>
                            <li>Отправка заказов осуществляется<br>Транспортными Компаниями;</li>
                            <li>Бесплатная доставка<br>по городам Крыма;</li>
                            <li>Действует система скидок!</li>
                        </ul>
